...
DEVELOPER :MASUM SORDAR
GITHUB    : Tounik1214
VERSION   : 2.0
PROJECT   : SMS BOMBER 
FACEBOOK  : Masum Sordar
××××××××××××××××××××××××××××××××××××××××××××"""
  for i in logo:
    sys.stdout.write(i)
    sys.stdout.flush()
...
××××××××××××××××××××××××××××××××××××××××××××
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ DEVELOPER :MD MASUM SORDAR
...
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ FACEBOOK  : Masum Sordar
××××××××××××××××××××××××××××××××××××××××××××"""
print(logo)
