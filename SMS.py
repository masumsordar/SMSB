...
""")
  os.system("xdg-open https://www.facebook.com/masum879?mibextid=ZbWKwL")
  sys.exit()
baner= os.system("figlet DADDY")
baner = str(baner)
baner = baner.replace("0","")
logo=f""" {baner} \033[1;37m
××××××××××××××××××××××××××××××××××××××××××××
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ 𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 : 𝙼𝙰𝚂𝚄𝙼 𝚂𝙾𝚁𝙳𝙰𝚁
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ 𝙶𝙸𝚃𝙷𝚄𝙱    : 𝙳𝙰𝙳𝙳𝚈
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ 𝚅𝙴𝚁𝚂𝙸𝙾𝙽   : 2.0
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ 𝙿𝚁𝙾𝙹𝙴𝙲𝚃   : 𝚂𝙼𝚂 𝙱𝙾𝙼𝙱𝙴𝚁 
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼  : D_ADDY_10
××××××××××××××××××××××××××××××××××××××××××××"""
print(logo)
print("[01] 𝚂𝚃𝙰𝚁𝚃 𝚂𝙼𝚂 𝙱𝙾𝙼𝙱𝙸𝙽𝙶 ")
print("[02] 𝙲𝙾𝙽𝚃𝙰𝙲𝚃 𝙼𝙴 𝙾𝙽 𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺 ")
print("××××××××××××××××××××××××××××××××××××××××××××")
